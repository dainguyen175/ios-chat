...
class RegisterViewController: UIViewController, UINavigationControllerDelegate {
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                // user already exists
                strongSelf.alertUserLoginError(message: "Email này đã được sử dụng.")
                return
            }
    ...
    func alertUserLoginError(message: String = "Bạn cần điền tất cả thông tin.") {
...
extension RegisterViewController: UIImagePickerControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Ảnh đại diện", message: "Bạn thích gì?", preferredStyle: .actionSheet)
